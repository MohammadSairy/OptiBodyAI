...
import com.gradproj.optibodyai.main_activity.host_screens.SELECT_GYM_SCREEN
import com.gradproj.optibodyai.ui.theme.SubTitle

@Composable
fun LocatingGymScreen(navController: NavHostController) {
    ...
    Column(Modifier.padding(horizontal = 18.dp)) {
        ...
        Box(
            ...
            LoadingCircle {
                navController.navigate(SELECT_GYM_SCREEN)  // Navigate to the next screen
            }
        }
    }
}
